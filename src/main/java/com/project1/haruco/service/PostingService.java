...
import com.project1.haruco.web.domain.certification.CertificationQueryRepository;
...
import com.project1.haruco.web.domain.posting.PostingQueryRepository;
...
public class PostingService {
    ...
    //포인트 지급. 인증이 50% 이상일 때, 포스팅이 승인 상태인지 아닌지의 여부 판단 후
